...
const AllItems = () => {
  ...
  const getBottomwear = async () => {
      // Fetch the Men's Clothing category from the API
      fetch('https://fakestoreapi.com/products')
      .then((response) => response.json())
      .then((data) => {
        // Filter out the products that belong to the "Men's Clothing" category
        const menClothingProducts = data.filter((product) => product.category === "men's clothing");
        setBottomwear(menClothingProducts);
      })
