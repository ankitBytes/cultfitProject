...
const Homepage = () => {
    ...
    return(
        <Box>
            ...
            <Grid item md={4}  data-aos="fade-up" data-aos-duration="2000">
            ...
            <Grid item sx={{padding: "2rem 0"}}  data-aos="fade-up" data-aos-duration="2000" aos-delay="500">
            ...
            <Grid item>
                <Button sx={styles.button} data-aos="fade-up" data-aos-duration="2000" aos-delay="1000">EXPLORE CULTPASS</Button>
            </Grid>
            <Grid item>
                <Button sx={styles.downArrowButton} disableRipple data-aos="fade-up" data-aos-duration="2000" aos-delay="1200"><KeyboardArrowDownIcon sx={styles.downIcon}/></Button>
            </Grid>
            </Grid>
        </Box>
    )
